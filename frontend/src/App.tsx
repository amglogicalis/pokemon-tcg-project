        ...
        <div className="flex items-center gap-6">
          ...
          {user && (
            <div className="relative">
              ...
              {showNotifDropdown && (
                <div className="absolute top-full right-[-60px] sm:right-0 mt-3 w-[85vw] max-w-[320px] sm:w-80 bg-gray-900/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-4 z-50 flex flex-col gap-3">
